        ...
        <div className="rounded-2xl bg-white h-fit w-1/2 my-6 mt-6 ml-24 mr-12">
            <div className="flex flex-col w-full">
                <div className='text-4xl text-center my-11 mx-11 min-w-fit'>
                    {InformationBlock("Previous Roles:", "", "", "When I first entered school, I was set on engineering (aerospace).", "I still would like to pursue engineering, or computational physics, but I eventually graduated with an Information Science degree.")}
