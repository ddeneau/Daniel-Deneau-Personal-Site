        ...
        <div className="flex rounded-2xl bg-white justify-items-center">
            <div className="flex flex-col">
                <div className='text-2xl text-center justify-items-center my-2 mx-11'>
                    ...
                    {ImagelessInformationBlock("Game Development Project", space_photo, null, "Working on two games right now. This city-builder pictured above, and a narrative action-adventure game")}
                </div>
                </div>
           </div>
    )
